...
export default function Home() {
   ...
   <section className="flex flex-col md:flex-row items-center justify-center gap-2 p-2 md:py-6" style={{ height: 'calc(80vh - 4rem)' }}>
            ...
            <div className="flex-1 flex flex-col items-center md:items-start">
                <h1 className="sm:text-lg font-bold mb-2 text-black">{currentProject.title}</h1>
    ...
    <a href={currentProject.link} className="flex items-center justify-center flex-1 sm:px-2 sm:py-2 px-4 py-3 bg-blue-800 text-white rounded-[10px] text-sm sm:text-base">
        <BookOpen size={15} className="mr-2" /> Explore
    </a>
...
<button onClick={handleNextClick} className="ml-2 sm:ml-3 md:ml-4 lg:ml-5"><ChevronRight size={16} /></button>
        </footer>
		</div>
